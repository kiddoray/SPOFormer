...
class MVP_16384(data.Dataset):
    def __init__(self, config):
        if config.subset=="train":
            self.file_path = '/mnt/data/digital_content_aigc/feiben/CrossPoint/data/mvp_train_input.h5'
            self.file_path_gt = '/mnt/data/digital_content_aigc/feiben/CrossPoint/data/mvp_train_gt_16384pts.h5'
        elif config.subset=="val":
            self.file_path = '/mnt/data/digital_content_aigc/feiben/CrossPoint/data/mvp_test_input.h5'
            self.file_path_gt = '/mnt/data/digital_content_aigc/feiben/CrossPoint/data/mvp_test_gt_16384pts.h5'
